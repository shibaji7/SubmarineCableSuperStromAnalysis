...
if __name__ == "__main__":
    ...
    op_count = getfile(
        "https://imag-data.bgs.ac.uk/GIN_V1/GINServices?Request=GetData&format=IAGA2002&testObsys=0&observatoryIagaCode=CNB&samplesPerDay=1440&orientation=Native&publicationState=adj-or-rep&recordTermination=UNIX&dataStartDate=2024-05-10&dataDuration=1",
        local_file,
        n_retries,
        4,
        gin_username,
    ...
    op_count = getfile(
        "https://imag-data.bgs.ac.uk/GIN_V1/GINServices?Request=GetData&format=IAGA2002&testObsys=0&observatoryIagaCode=CNB&samplesPerDay=1440&orientation=Native&publicationState=adj-or-rep&recordTermination=UNIX&dataStartDate=2024-05-11&dataDuration=1",
        local_file,
        n_retries,
        5,
        gin_username,
    ...
    op_count = getfile(
        "https://imag-data.bgs.ac.uk/GIN_V1/GINServices?Request=GetData&format=IAGA2002&testObsys=0&observatoryIagaCode=CTA&samplesPerDay=1440&orientation=Native&publicationState=adj-or-rep&recordTermination=UNIX&dataStartDate=2024-05-10&dataDuration=1",
        local_file,
        n_retries,
        6,
        gin_username,
    ...
    op_count = getfile(
        "https://imag-data.bgs.ac.uk/GIN_V1/GINServices?Request=GetData&format=IAGA2002&testObsys=0&observatoryIagaCode=CTA&samplesPerDay=1440&orientation=Native&publicationState=adj-or-rep&recordTermination=UNIX&dataStartDate=2024-05-11&dataDuration=1",
        local_file,
        n_retries,
        7,
        gin_username,
    ...
    op_count = getfile(
        "https://imag-data.bgs.ac.uk/GIN_V1/GINServices?Request=GetData&format=IAGA2002&testObsys=0&observatoryIagaCode=GUA&samplesPerDay=1440&orientation=Native&publicationState=adj-or-rep&recordTermination=UNIX&dataStartDate=2024-05-10&dataDuration=1",
        local_file,
        n_retries,
        8,
        gin_username,
    ...
    op_count = getfile(
        "https://imag-data.bgs.ac.uk/GIN_V1/GINServices?Request=GetData&format=IAGA2002&testObsys=0&observatoryIagaCode=GUA&samplesPerDay=1440&orientation=Native&publicationState=adj-or-rep&recordTermination=UNIX&dataStartDate=2024-05-11&dataDuration=1",
        local_file,
        n_retries,
        9,
        gin_username,
    ...
    op_count = getfile(
        "https://imag-data.bgs.ac.uk/GIN_V1/GINServices?Request=GetData&format=IAGA2002&testObsys=0&observatoryIagaCode=KAK&samplesPerDay=1440&orientation=Native&publicationState=adj-or-rep&recordTermination=UNIX&dataStartDate=2024-05-10&dataDuration=1",
        local_file,
        n_retries,
        10,
        gin_username,
    ...
    op_count = getfile(
        "https://imag-data.bgs.ac.uk/GIN_V1/GINServices?Request=GetData&format=IAGA2002&testObsys=0&observatoryIagaCode=KAK&samplesPerDay=1440&orientation=Native&publicationState=adj-or-rep&recordTermination=UNIX&dataStartDate=2024-05-11&dataDuration=1",
        local_file,
        n_retries,
        11,
        gin_username,
